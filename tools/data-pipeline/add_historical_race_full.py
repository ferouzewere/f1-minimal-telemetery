...
BASE_PUBLIC_DIR = 'apps/frontend/public'
DATA_DIR = os.path.join(BASE_PUBLIC_DIR, 'data')
MANIFEST_PATH = os.path.join(BASE_PUBLIC_DIR, 'sessions.json')
...
def fetch_and_add_race(year, race_name, lap_count=5):
    ...
    data_filename = os.path.join(DATA_DIR, f"{year}_{safe_name}_analysis.json")
