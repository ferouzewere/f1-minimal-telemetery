    ...
    return (
        <div className="driver-table-container">
            ...
            <div className="table-header">
                ...
                <div className="th-cell th-driver">{isMobile ? 'DRV' : 'DRIVER'}</div>
                <div className="th-cell th-tyre">{isMobile ? 'T' : 'TYRE'}</div>
                <div className="th-cell th-gap">GAP</div>
                <div className="th-cell th-last">{isMobile ? 'LAP' : 'LAST LAP'}</div>
                <div className="th-cell th-sect">{isMobile ? 'S' : 'SECTOR'}</div>
            </div>
